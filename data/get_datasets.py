...
from data.cifar import get_cifar_10_datasets, get_cifar_100_datasets, get_cifar_100_datasets_with_gcdval
from data.herbarium_19 import get_herbarium_datasets, get_herbarium_datasets_with_gcdval
from data.stanford_cars import get_scars_datasets, get_scars_datasets_with_gcdval
from data.imagenet import get_imagenet_100_datasets, get_imagenet_100_gcd_datasets_with_gcdval
from data.cub import get_cub_datasets, get_cub_datasets_with_gcdval
from data.fgvc_aircraft import get_aircraft_datasets, get_aircraft_datasets_with_gcdval
...
get_dataset_funcs_with_gcdval = {
    ...
    'imagenet_100': get_imagenet_100_gcd_datasets_with_gcdval,
    'aircraft': get_aircraft_datasets_with_gcdval,
    'scars': get_scars_datasets_with_gcdval,
    'herbarium_19': get_herbarium_datasets_with_gcdval
}
...
def get_datasets_with_gcdval(dataset_name, train_transform, test_transform, args):
    ...
    datasets = get_dataset_f(train_transform=train_transform, test_transform=test_transform,
                            train_classes=args.train_classes,
                            prop_train_labels=args.prop_train_labels,
                            split_train_val=True, val_split=0.1)
