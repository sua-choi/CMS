...
car_root = "/home/suachoi/datasets/stanford_car/cars_{}/"
meta_default_path = "/home/suachoi/datasets/stanford_car/devkit/cars_{}.mat"
...
def subsample_dataset(dataset, idxs, absolute=True):
    ...
    dataset.data = np.array(dataset.data)[mask].tolist()
    dataset.target = np.array(dataset.target)[mask].tolist()
...
def get_scars_datasets_with_gcdval(train_transform, test_transform, train_classes=range(80), 
