...
def subsample_dataset(dataset, idxs, absolute=True):
    ...
    dataset.samples = [(p, t) for m, (p, t) in zip(mask, dataset.samples) if m==True]
...
def get_aircraft_datasets_with_gcdval(train_transform, test_transform, train_classes=range(80), 
