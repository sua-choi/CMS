...
def get_train_val_indices(train_dataset, val_instances_per_class=5):
    ...
    for cls in train_classes:
        ...
        val_size = min(cls_idxs.shape[0], val_instances_per_class)
...
def get_herbarium_datasets_with_gcdval(train_transform, test_transform, train_classes=range(80), 
    ...
    train_idxs, val_idxs = get_train_val_indices(train_dataset_unlabelled, val_instances_per_class=5)
